...
{
    public partial class FrmBuscarEmpleadoPorCedula : Form
    {
        ...
        private void FillGrid(String value)
        {
            try
            {
                EmpleadosDTOBindingSource.DataSource = UnitOfWork.EmpleadosS.GetByCedula(value);
        ...
        public FrmBuscarEmpleadoPorCedula()
        {
            InitializeComponent();
        }
        ...
        private void FrmBuscarEmpleadoPorCedula_Load(object sender, EventArgs e)
        {
