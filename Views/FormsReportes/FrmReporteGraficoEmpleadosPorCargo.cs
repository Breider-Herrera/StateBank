...
{
    public partial class FrmReporteGraficoEmpleadosPorCargo : Form
    {
        public FrmReporteGraficoEmpleadosPorCargo()
        {
            InitializeComponent();
        }
        ...
        private void FrmReporteGraficoEmpleadosPorCargo_Load(object sender, EventArgs e)
        {
